(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('solid-js'), require('reflect-metadata'), require('@vgerbot/lazy'), require('solid-js/web'), require('solid-js/store')) :
    typeof define === 'function' && define.amd ? define(['exports', 'solid-js', 'reflect-metadata', '@vgerbot/lazy', 'solid-js/web', 'solid-js/store'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Solidium = {}, global.solidJs, null, global.lazy, global.web, global.store$1));
})(this, (function (exports, solidJs, reflectMetadata, lazy, web, store$1) { 'use strict';
