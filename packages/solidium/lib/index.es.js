import { createSignal, runWithOwner, getOwner, onCleanup, createContext, createRoot, batch, createMemo, untrack, createEffect, on, useContext } from 'solid-js';
import 'reflect-metadata';
import { lazyMember, lazyProp } from '@vgerbot/lazy';
...
function afterInstantiation(instance, container) {
  ...
  if (allClassProcessors) {
    allClassProcessors.forEach(processor => {
      var _a;
      const newInstance = (_a = processor.afterInstantiation) === null || _a === void 0 ? void 0 : _a.call(processor, instance, metadata, container);
...
function Solidium(props) {
  ...
  appCtx.registerBeforeInstantiationProcessor(constructor => {
  ...
  appCtx.registerAfterInstantiationProcessor(instance => afterInstantiation(instance, appCtx));
