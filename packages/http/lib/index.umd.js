(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined'
        ? factory(
              exports,
              require('@vgerbot/ioc'),
              require('@vgerbot/lazy'),
              require('@vgerbot/persistence'),
              require('@vgerbot/solidium'),
              require('rxjs'),
              require('solid-js'),
              require('@solid-primitives/scheduled')
          )
    ...
    ***************************************************************************** */
        ...
        var HttpResponse = /** @class */ (function () {
            ...
            HttpResponse.prototype.textStream = function () {
                return __asyncGenerator(
                    this,
                    arguments,
                    function textStream_1(encoding) {
                        var byteStream,
                            stream,
                            reader,
                            decoder,
            ...
            HttpResponse.prototype.jsonStream = function () {
                return __asyncGenerator(
                    this,
                    arguments,
                    function jsonStream_1(encoding) {
        ...
        var Defer = /** @class */ (function () {
            ...
            Defer.fromArray = function (array, mapfn) {
                ...
                if (typeof mapfn !== 'function') {
                    Promise.all(Array.from(array)).then(
                        defer.resolve,
                        defer.reject
                    );
                } else {
                    Promise.all(
                        Array.from(array, function (value) {
        ...
        var HttpHeaders = /** @class */ (function () {
            ...
            HttpHeaders.prototype.append = function (name) {
                ...
                var originValues =
                    (_a = this.headers.get(name)) !== null && _a !== void 0
                        ? _a
                        : [];
            ...
            HttpHeaders.prototype.getContentLength = function () {
                ...
                var contentLengthStr = (
                    (_a = this.get('content-length')) !== null && _a !== void 0
                        ? _a
                        : []
                )[0];
        ...
        var Progress = /** @class */ (function () {
            ...
            Progress.prototype.percent = function (suffix, fractionDigits) {
                ...
                return (
                    (this.total
                        ? Math.trunc(
                              (this.loaded / this.total) * 100 * p + 0.5
                          ) / p
                        : 0
        ...
        var ProgressiveByteStream = /** @class */ (function () {
            ...
            ProgressiveByteStream.prototype.updateProgress = function (
                progress
            ) {
        ...
        var BlobByteStream = /** @class */ (function (_super) {
            ...
            BlobByteStream.prototype.readAsStream = function () {
                ...
                return createProgressiveReadableStream(
                    this.blob.stream(),
                    function (loaded) {
        ...
        var IGNORE_DUPLICATE_OF = new Set([
            'age',
            'authorization',
            'content-length',
            'content-type',
        ...
        function parseHeaders(rawHeaders) {
            var result = new Map();
            if (
                !(rawHeaders === null || rawHeaders === void 0
                    ? void 0
                    : rawHeaders.trim())
            ) {
                return result;
            ...
            rawHeaders.split(/[\r\n]+/).forEach(function (line) {
                ...
                var values =
                    (_a = result.get(key)) !== null && _a !== void 0 ? _a : [];
                values.push(value);
            ...
            function XMLHttpRequestAdapter(options) {
                ...
                xhr.addEventListener('readystatechange', function () {
                    ...
                    if (xhr.readyState === XMLHttpRequest.HEADERS_RECEIVED) {
                        ...
                        _this.bodyDefer.resolve(
                            new BlobByteStream(
                                (_a = xhr.response) !== null && _a !== void 0
                                    ? _a
                                    : new Blob([])
                            )
                        );
            ...
            XMLHttpRequestAdapter.prototype.execute = function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        ...
                        (_a = this),
                            (headersDefer = _a.headersDefer),
                            (bodyDefer = _a.bodyDefer),
                            (statusDefer = _a.statusDefer),
                            (events = _a.events);
                        return [
                            2 /*return*/,
                            {
        ...
        function joinPath() {
            ...
            return paths.reduce(function (baseUrl, path) {
                var cleanedBaseUrl = baseUrl.endsWith('/')
                    ? baseUrl.slice(0, -1)
                    : baseUrl;
        ...
        function resolveURL(routeTemplate, pathVariables, queryParameters) {
            var pathParamReplacedURL = routeTemplate.replace(
                /(:([a-z]+))/gi,
                function (fullMatch, placeholder, variableName) {
                    var _a, _b;
                    if (variableName in pathVariables) {
                        return (_b =
                            (_a = pathVariables[variableName]) === null ||
                            _a === void 0
                                ? void 0
         ...
         */
        var ProxyAuthenticationRequiredError = /** @class */ (function (
            _super
        ) {
         ...
         */
        var RequestHeaderFieldsTooLargeError = /** @class */ (function (
            _super
        ) {
        ...
        var UnavailableForLegalReasonsError = /** @class */ (function (_super) {
            ...
            function UnavailableForLegalReasonsError(
                headers,
                responseBody,
                message
            ) {
         ...
         */
        var NetworkAuthenticationRequiredError = /** @class */ (function (
            _super
        ) {
        ...
        var ErrorContextInterceptor = /** @class */ (function () {
            ...
            ErrorContextInterceptor.prototype.invoke = function (
                instance,
                method,
                params,
                next
        ...
        var RetryInterceptor = /** @class */ (function () {
            ...
            RetryInterceptor.prototype.invoke = function (
                instance,
                method,
                params,
                next
        ...
        var MaxRetryAttemptsReachedError = /** @class */ (function (_super) {
            ...
            function MaxRetryAttemptsReachedError(attempts, originalError) {
                var _this =
                    _super.call(this, 'Max retry attempts reached') || this;
        ...
        var TimeoutInterceptor = /** @class */ (function () {
            ...
            TimeoutInterceptor.prototype.invoke = function (
                instance,
                method,
                params,
                next
        ...
        var ErrorWrappingInterceptor = /** @class */ (function () {
            ...
            ErrorWrappingInterceptor.prototype.invoke = function (
                instance,
                method,
                params,
                next
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                if (
                                    error_1 instanceof DOMException &&
                                    ...
                                    error_1.message.includes('NetworkError')
                                ) {
                                    ...
                                    error_1 instanceof TypeError &&
                                    error_1.message.includes('timeout')
                                ) {
                                    ...
                                    error_1 instanceof SyntaxError &&
                                    error_1.message.includes('JSON')
                                ) {
        ...
        var RequestMethod = /** @class */ (function () {
            function RequestMethod(name, endpointMetadata, metadata) {
                ...
                if (isURL(pathOrURL)) {
                    ...
                    this.url = joinPath(
                        this.endpointMetadata.getBaseURL(),
                        pathOrURL
                    );
                }
                ...
                if (retryConfig) {
                    this.baseInterceptors.push(
                        new RetryInterceptor(retryConfig)
                    );
                }
            }
            RequestMethod.get = function (instance, name) {
                var _a;
                return (_a = instance[METHODS]) === null || _a === void 0
                    ? void 0
                    : _a.get(name);
            };
            RequestMethod.prototype.getAllInterceptors = function (instance) {
                var timeout =
                    ...
                    this.endpointMetadata.getTimeout();
                var extInterceptors = [];
                if (timeout > 0) {
                    extInterceptors.push(
                ...
                var excludeInterceptors =
                    this.metadata.getExcludeInterceptors();
                var endpointInterceptors =
                    instance[GET_INTERCEPTORS](excludeInterceptors);
                var methodInterceptors = instance[CONSTRUCT_INTERCEPTORS](
                    this.metadata.getInterceptors()
                );
                var allInterceptors = __spreadArray(
                    __spreadArray(
                        __spreadArray(
                            __spreadArray([], this.baseInterceptors, true),
                            extInterceptors,
                            true
                        ),
            ...
            RequestMethod.prototype.resolveURL = function (params) {
                ...
                return resolveURL(
                    this.url,
                    (_a = params.pathVariables) !== null && _a !== void 0
                        ? _a
                        : {},
                    params.queryParams
                );
            };
            RequestMethod.prototype.createAdapter = function (
                instance,
                params
            ) {
                var _a, _b, _c;
                ...
                var adapter = new (
                    (_c =
                        (_b =
                            (_a = params.adapter) !== null && _a !== void 0
                                ? _a
                                : this.metadata.getAdapter()) !== null &&
                        _b !== void 0
                            ? _b
                            : instance[ADAPTER]) !== null && _c !== void 0
                        ? _c
        ...
        var CircuitBreakerInterceptor = /** @class */ (function () {
            ...
            CircuitBreakerInterceptor.of = function (config) {
                ...
                var SubCircuitBreakerInterceptor = /** @class */ (function (
                    _super
                ) {
            ...
            CircuitBreakerInterceptor.prototype.invoke = function (
                instance,
                method,
                params,
                next
            ...
            NativeReadableStream.prototype.readAsStoredBlob = function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        loaded = 0;
                        this.blobPromise = new Promise(function (
                            resolve,
                            reject
                        ) {
                            var chunks = [];
            ...
            function FetchRequestAdapter(options) {
                ...
                this.executeRequestIfNeed = function () {
                    ...
                    fetch(options.url, {
                        ...
                        _this.headersDefer.resolve(
                            new HttpHeaders(response.headers)
                        );
                        if (!response.body) {
                            _this.bodyDefer.resolve(
                                new BlobByteStream(new Blob([]))
                            );
                        } else {
                            var rawContentLength =
                                response.headers.get('Content-Length');
                            var contentLength = rawContentLength
        ...
        var DEFAULT_HTTP_CONFIGURATION = Symbol(
            ...
            Http.configure = function (config) {
                /** @class */ (function () {
                    ...
                    HttpConfigurationFactory.prototype.produce = function () {
                        var _a;
                        (_a = config.cacheBucket) !== null && _a !== void 0
                            ? _a
                    ...
                    __decorate(
                        [
                            ...
                            __metadata(
                                'design:type',
                                solidiumPersistence.Persistence
                            )
                        ],
                        HttpConfigurationFactory.prototype,
                        'persistence',
                        void 0
                    );
                    __decorate(
                        [
                            ioc.Inject(solidiumPersistence.DEFAULT_BUCKET),
                            __metadata(
                                'design:type',
                                solidiumPersistence.Bucket
                            )
                        ],
                        HttpConfigurationFactory.prototype,
                        'defaultBucket',
                    ...
                    __decorate(
                        [
                            ioc.Factory(DEFAULT_HTTP_CONFIGURATION),
        ...
        function buildEndpointClass(endpointClass, metadata) {
            Reflect.set(
                ...
                function (exclude) {
                    ...
                    var globalInterceptors =
                        (_b =
                            (_a = this[HTTP_CONFIGURATION]) === null ||
                            _a === void 0
                                ? void 0
                                : _a.interceptors) !== null && _b !== void 0
                            ? _b
                            : [];
                    return __spreadArray(
                        __spreadArray([], globalInterceptors, true),
                        metadata.getInterceptors(),
                        true
                    )
                        .filter(function (it) {
                            return !(exclude === null || exclude === void 0
                                ? void 0
                                : exclude.includes(it));
                        })
                        .map(function (identifier) {
                            ...
                            return _this[APPLICATION_CONTEXT].getInstance(
                                identifier
                            );
                        })
                        .flat();
            ...
            lazy.lazyMember(function () {
                ...
                metadata
                    .getMethods()
                    .forEach(function (methodMetadata, methodName) {
                        methods.set(
                            methodName,
                            new RequestMethod(
                                methodName,
            ...
            ioc.Inject(ioc.ApplicationContext)(
                endpointClass.prototype,
                APPLICATION_CONTEXT
            );
            ioc.Inject(DEFAULT_HTTP_CONFIGURATION)(
                endpointClass.prototype,
                HTTP_CONFIGURATION
            );
        }
        ...
        var RequestMethodMetadata = /** @class */ (function () {
            ...
            RequestMethodMetadata.prototype.appendExecutionHandler = function (
                handler
            ) {
            ...
            RequestMethodMetadata.prototype.getHeaders = function () {
                ...
                headers.setAll(
                    (_a = this.options.headers) !== null && _a !== void 0
                        ? _a
                        : {}
                );
                return headers;
            ...
            RequestMethodMetadata.prototype.getTimeout = function () {
                var _a;
                return (_a = this.options.timeout) !== null && _a !== void 0
                    ? _a
                    : 0;
            };
            RequestMethodMetadata.prototype.getInterceptors = function () {
                var _a;
                return (
                    (_a = this.options.interceptors) !== null && _a !== void 0
                        ? _a
                        : []
                ).concat(this.externalInterceptors);
            };
            RequestMethodMetadata.prototype.getExcludeInterceptors =
                function () {
                    var _a;
                    return (_a = this.options.excludeInterceptors) !== null &&
                        _a !== void 0
                        ? _a
                        : [];
                };
            ...
            RequestMethodMetadata.prototype.isReactive = function () {
                var _a;
                return (_a = this.options.reactive) !== null && _a !== void 0
                    ? _a
                    : true;
            };
            RequestMethodMetadata.prototype.appendInterceptor = function (
                interceptor
            ) {
        ...
        var EndpointMetadata = /** @class */ (function () {
            ...
            EndpointMetadata.prototype.setOptions = function (endpointOptions) {
                ...
                if ('extends' in endpointOptions) {
                    var parent_1 = EndpointMetadata.from(
                        endpointOptions.extends
                    );
                    this.baseURL =
                        (_a = endpointOptions.baseURL) !== null && _a !== void 0
                            ? _a
                            : parent_1.baseURL;
                ...
                this.baseURL = joinPath(
                    this.baseURL,
                    (_b = endpointOptions.path) !== null && _b !== void 0
                        ? _b
                        : ''
                );
            ...
            EndpointMetadata.prototype.getMethodMetadata = function (
                methodName
            ) {
            ...
            EndpointMetadata.prototype.setMethodMetadata = function (
                methodName,
                methodMetadata
            ) {
            ...
            EndpointMetadata.prototype.getInterceptors = function () {
                var _a;
                return (_a = this.interceptors) !== null && _a !== void 0
                    ? _a
                    : [];
            };
            ...
            return function decorateMethod(target, context, descriptor) {
                if (
                    ...
                    context.addInitializer(function () {
                        ...
                        var method =
                            EndpointMetadata.from(clazz).getMethodMetadata(
                                propertyKey_1
                            );
                        var descriptor = decorator(
                            clazz,
                            propertyKey_1,
                            method
                        );
        ...
        function Request(options) {
            return decorateEndpointMethod(
                function (clazz, methodName, methodMetadata) {
        ...
        function Header(name, defaultValue) {
            return function (target, methodName, parameterIndex) {
                appendExecHandler(
                    target.constructor,
                    methodName,
                    function (instance, metadata, params, args) {
                        var _a;
                        var _b;
                        var value =
                            (_b = args[parameterIndex]) !== null &&
                            _b !== void 0
                                ? _b
                                : defaultValue;
                        if (value) {
                            (_a = params.headers).append.apply(
                                _a,
                                __spreadArray(
                                    [name],
        ...
        var SWRInstance = /** @class */ (function () {
                    ...
                    return __generator(this, function (_g) {
                        switch (_g.label) {
                            case 0:
                                now = Date.now();
                                dedupingInterval =
                                    (_a = this.config.dedupingInterval) !==
                                        null && _a !== void 0
                                        ? _a
                                        : 2000;
                                if (
                            ...
                            case 3:
                                ...
                                if (
                                    ...
                                    if (
                                        ((_c = (_b = this.config.retry)
                                            .shouldRetryOnError) === null ||
                                        _c === void 0
                                            ? void 0
                                            : _c.call(_b, retryContext)) !==
                                        false
                                    ) {
                                        this.currentRetryAttempt++;
                                        delay =
                                            (_f =
                                                (_e = (_d = this.config.retry)
                                                    .calculateDelay) === null ||
                                                _e === void 0
                                                    ? void 0
                                                    : _e.call(
            ...
            SWRInstance.prototype.initRevalidationStrategy = function () {
                ...
                var _a;
                var _b =
                        (_a = this.config.revalidate) !== null && _a !== void 0
                            ? _a
                            : {},
                    focus = _b.focus,
            ...
            SWRInstance.prototype.setupRefreshInterval = function () {
                ...
                var _a;
                if (
                    ((_a = this.config.refresh) === null || _a === void 0
                        ? void 0
                        : _a.interval) &&
                    this.config.refresh.interval > 0
                ) {
                    this.refreshInterval = setInterval(function () {
                        var _a, _b;
                        if (
                            (document.hidden &&
                                !((_a = _this.config.refresh) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.whenHidden)) ||
                            (!navigator.onLine &&
                                !((_b = _this.config.refresh) === null ||
                                _b === void 0
                                    ? void 0
                                    : _b.whenOffline))
                        ) {
                                            ...
                                            case 1:
                                                ...
                                                key = (function () {
                                                    ...
                                                    if (
                                                        ...
                                                        return _keygen.apply(
                                                            void 0,
                                                            args
                                                        );
                                                    }
                                                    return method.resolveURL(
                                                        params
                                                    );
                                                })();
                                                swrInstance =
                                                    swrService.obtainInstance(
                                                        key
                                                    );
                                                swrInstance === null ||
                                                swrInstance === void 0
            ...
            return function (target, propertyKey) {
                var methodName =
                    typeof propertyKey === 'object'
                        ? propertyKey.name
                        : propertyKey;
                var methodMetadata = EndpointMetadata.from(
                    target.constructor
        ...
        function isJSON(contentType) {
            return (
                !!contentType &&
                JSON_CONTENT_TYPES.some(function (type) {
        ...
        var ResourceExecutionState = /** @class */ (function (_super) {
                    ...
                    error: function (err) {
                        ...
                        _this.status =
                            err instanceof ResourceError && err.isAbortError
                                ? exports.RequestStatus.ABORTED
                                : exports.RequestStatus.ERROR;
                    }
                });
            };
            ResourceExecutionState.prototype.headerReceived = function (
                headers,
                httpStatus
            ) {
            ...
            __decorate(
                [solidium.Signal(), __metadata('design:type', Array)],
                ResourceExecutionState.prototype,
                'messages',
                void 0
            );
            __decorate(
                [solidium.Signal(), __metadata('design:type', Object)],
                ResourceExecutionState.prototype,
                'data',
                void 0
            );
            ...
            __decorate(
                [solidium.Signal(), __metadata('design:type', Number)],
                ResourceExecutionState.prototype,
                'status',
                void 0
            );
            ...
            ResourceExecutionState = __decorate(
                [
                    ioc.Scope(ioc.InstanceScope.TRANSIENT),
                    __metadata('design:paramtypes', [])
                ],
        ...
        var Resource = /** @class */ (function () {
            ...
            Object.defineProperty(Resource.prototype, 'data', {
                get: function () {
                    var _a;
                    return (_a = this.state) === null || _a === void 0
                        ? void 0
                        : _a.data;
                },
                enumerable: false,
            ...
            Resource.prototype[EXECUTE] = function (force, state) {
                ...
                var lastExecutionAbortController =
                    (_a = this.state) === null || _a === void 0
                        ? void 0
                        : _a.abortController;
                lastExecutionAbortController === null ||
                lastExecutionAbortController === void 0
                    ? void 0
                ...
                var sendRequest = allInterceptors.reduceRight(
            ...
            Resource.prototype.resolveResponseBody = function (response) {
                return __asyncGenerator(
                    this,
                    arguments,
                    function resolveResponseBody_1() {
                        var headers,
                            contentType,
                            error_1,
                            parseError,
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    return [
                                        4 /*yield*/,
                                        __await(response.headers())
                                    ];
                                case 1:
                                    headers = _b.sent();
                                    contentType =
                                        (_a = headers.get('content-type')) ===
                                            null || _a === void 0
                                            ? void 0
                                            : _a.join(', ');
                                ...
                                case 14:
                                    return [
                                        4 /*yield*/,
                                        __await(response.body())
                                    ];
                                case 15:
                                    byteStream = _b.sent();
                                    return [
                                        4 /*yield*/,
                                        __await(byteStream.readAsBlob())
                                    ];
                                case 16:
                                    return [4 /*yield*/, _b.sent()];
                                case 17:
                    ...
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            ...
                            case 4:
                                ...
                                (_c = true),
                                    (_d = __asyncValues(
                                        this.resolveResponseBody(response)
                                    ));
                                _j.label = 5;
                            case 5:
                                return [4 /*yield*/, _d.next()];
                            case 6:
                                if (!((_e = _j.sent()), (_f = _e.done), !_f))
                                    return [3 /*break*/, 8];
                                _h = _e.value;
                                _c = false;
                                data = _h;
                    ...
                    return __generator(this, function (_h) {
                        switch (_h.label) {
                            ...
                            case 13:
                                return [7 /*endfinally*/];
                            case 14:
                                responseBody = isTextEventStream(contentType)
                                    ? datas
                                    : datas[0];
                                httpError = HttpStatusErrorFactory.createError(
                                    httpStatus,
            ...
            __decorate(
                [
                    solidium.Signal(),
                    __metadata('design:type', ResourceExecutionState)
                ],
                Resource.prototype,
                'state',
                void 0
            ...
            __decorate(
                [
                    ioc.Inject(),
                    __metadata('design:type', ioc.ApplicationContext)
                ],
                Resource.prototype,
                'ioc',
                void 0
        ...
        var RestfulResource = /** @class */ (function (_super) {
            ...
            RestfulResource.prototype[EXECUTE] = function (force) {
                ...
                var methodMetadata = context.method.metadata;
                var _keygen = methodMetadata.getExtra(
                    EXTRA_METADATA_SWR_KEYGEN
                );
                var mutate =
                    (_a = methodMetadata.getExtra(EXTRA_METADATA_MUTATE)) !==
                        null && _a !== void 0
                        ? _a
                        : false;
                var swrConfig = methodMetadata.getExtra(
                    EXTRA_METADATA_SWR_CONFIG
                );
                if (mutate && swrConfig) {
                    throw new Error(
                        '@SWR and @SWRMutation cannot be used together'
                    );
                }
                if (!swrConfig) {
                ...
                var keygen = function () {
                    ...
                    if (typeof _keygen === 'function') {
                        return _keygen.apply(void 0, args);
                    }
                    return context.method.resolveURL(context.params);
                };
                var instance = this.swrService.useSWR(
                    keygen,
                    function () {
                        var state = _this.ioc.getInstance(
                            ResourceExecutionState
                        );
            ...
            __decorate(
                [ioc.Inject(), __metadata('design:type', SWRService)],
                RestfulResource.prototype,
                'swrService',
                void 0
            );
            RestfulResource = __decorate(
                [ioc.Scope(ioc.InstanceScope.TRANSIENT)],
                RestfulResource
            );
        ...
        var JSONSSEResource = /** @class */ (function (_super) {
            ...
            JSONSSEResource.prototype.resolveResponseBody = function (
                response
            ) {
                return __asyncGenerator(
                    this,
                                ...
                                case 4:
                                    return [
                                        ...
                                        __values(
                                            __asyncDelegator(
                                                __asyncValues(
                                                    _super.prototype.resolveResponseBody.call(
                                                        this,
                                                        response
                                                    )
                                                )
        ...
        var ProgressiveResource = /** @class */ (function (_super) {
            ...
            __decorate(
                [solidium.Signal(), __metadata('design:type', Progress)],
                ProgressiveResource.prototype,
                'progress',
                void 0
            );
        ...
        var DownloadResource = /** @class */ (function (_super) {
            ...
            DownloadResource.prototype.handleResponse = function (
                response,
                state
            ) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        return [
                            2 /*return*/,
                            _super.prototype.handleResponse.call(
                                this,
                                response,
                                state
                            )
            ...
            DownloadResource.prototype.resolveResponseBody = function (
                response
            ) {
                return __asyncGenerator(
                    this,
            ...
            __decorate(
                [solidium.Signal(), __metadata('design:type', Progress)],
                DownloadResource.prototype,
                'progress',
                void 0
            );
            DownloadResource = __decorate(
                [ioc.Scope(ioc.InstanceScope.TRANSIENT)],
                DownloadResource
            );
        ...
        var UploadResource = /** @class */ (function (_super) {
            ...
            UploadResource.prototype.handleResponse = function (
                response,
                state
            ) {
                return __awaiter(this, void 0, void 0, function () {
        ...
        var CacheInterceptor = /** @class */ (function () {
            ...
            Object.defineProperty(CacheInterceptor.prototype, 'policy', {
                get: function () {
                    var _a;
                    return (_a = this.config.policy) !== null && _a !== void 0
                        ? _a
            ...
            CacheInterceptor.prototype.getBucket = function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        ...
                        bucketName =
                            (_a = this.config.bucketName) !== null &&
                            _a !== void 0
                                ? _a
                                : (_b = this.httpConfig) === null ||
                                    _b === void 0
                                  ? void 0
                                  : _b.cacheBucket;
                        if (bucketName) {
                            try {
                                this.bucket =
                                    this.appCtx.getInstance(bucketName);
                                return [2 /*return*/, this.bucket];
                            } catch (_d) {
                                // Bucket not found, fall back to default
                            }
                        }
                        this.bucket = this.appCtx.getInstance(
                            solidiumPersistence.DEFAULT_BUCKET
                        );
                        return [2 /*return*/, this.bucket];
                    });
                });
            };
            CacheInterceptor.prototype.generateCacheKey = function (
                method,
                params
            ) {
            ...
            CacheInterceptor.prototype.getExpirationFromHeaders = function (
                headers
            ) {
            ...
            CacheInterceptor.prototype.invoke = function (
                instance,
                method,
                params,
                next
        ...
        exports.ProxyAuthenticationRequiredError =
            ProxyAuthenticationRequiredError;
        exports.Put = Put;
        exports.Query = Query;
        exports.RangeNotSatisfiableError = RangeNotSatisfiableError;
        exports.Request = Request;
        exports.RequestHeaderFieldsTooLargeError =
        ...
        exports.UnavailableForLegalReasonsError =
