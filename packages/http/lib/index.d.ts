...
declare const DEFAULT_HTTP_CONFIGURATION: unique symbol;
declare class Http {
    static configure(config: HttpConfiguration): typeof Http;
    init(): void;
}
