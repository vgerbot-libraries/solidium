...
class HttpResponse {
    ...
    textStream() {
        return __asyncGenerator(
            this,
            arguments,
            function* textStream_1(encoding = 'UTF-8') {
    ...
    jsonStream() {
        return __asyncGenerator(
            this,
            arguments,
            function* jsonStream_1(encoding = 'UTF-8') {
                var _a, e_1, _b, _c;
                var _d;
                const regex =
                    /event:\s*?([^\s\n\r]+?)[\n\r\s]*data:\s*?(.*?)\s*$/i;
                try {
                    for (
                        var _e = true,
                            _f = __asyncValues(this.textStream(encoding)),
                            _g;
                        (_g = yield __await(_f.next())), (_a = _g.done), !_a;
                        _e = true
                    ) {
                        _c = _g.value;
                        _e = false;
                        const chunk = _c;
                        const [, event, data] =
                            (_d = regex.exec(chunk)) !== null && _d !== void 0
                                ? _d
                                : [];
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    try {
                        for (
                            var _d = true,
                                _e = __asyncValues(readStream(stream)),
                                _f;
...
class RetryInterceptor {
    constructor(config = {}) {
        this.config = Object.assign(
            Object.assign({}, DEFAULT_CONFIG$2),
            config
        );
    }
    delay(ms) {
...
class TimeoutInterceptor {
    constructor(config = {}) {
        this.config = Object.assign(
            Object.assign({}, DEFAULT_CONFIG$1),
            config
        );
    }
    invoke(instance, method, params, next) {
...
class NativeReadableStream extends ProgressiveByteStream {
                ...
                (() =>
                    __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            for (
                                var _d = true,
                                    _e = __asyncValues(readStream(this.stream)),
                                    _f;
                                (_f = yield _e.next()), (_a = _f.done), !_a;
                                _d = true
                            ) {
                ...
                __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        try {
                            for (
                                var _d = true,
                                    _e = __asyncValues(readStream(blobStream)),
                                    _f;
                                (_f = yield _e.next()), (_a = _f.done), !_a;
                                _d = true
                            ) {
    ...
    readAsBlob() {
        return __awaiter(
            ...
            arguments,
            void 0,
            function* (contentType = 'application/octet-stream') {
                const blob = yield this.readAsStoredBlob();
...
const DEFAULT_HTTP_CONFIGURATION = Symbol(
    ...
    revalidate(reason) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dedupingInterval =
                (_a = this.config.dedupingInterval) !== null && _a !== void 0
                    ? _a
                    : 2000;
            ...
            try {
                ...
                if (
                    ...
                    if (
                        ((_c = (_b = this.config.retry).shouldRetryOnError) ===
                            null || _c === void 0
                            ? void 0
                ...
                if (
                    (document.hidden &&
                        !((_a = this.config.refresh) === null || _a === void 0
                            ...
                            : _a.whenHidden)) ||
                    (!navigator.onLine &&
                        !((_b = this.config.refresh) === null || _b === void 0
                            ? void 0
                            : _b.whenOffline))
                ) {
                    return;
...
__decorate(
    [Signal(), __metadata('design:type', Array)],
    ResourceExecutionState.prototype,
    'messages',
    void 0
);
__decorate(
    [Signal(), __metadata('design:type', Object)],
    ResourceExecutionState.prototype,
    'data',
    void 0
);
...
__decorate(
    [Signal(), __metadata('design:type', Number)],
    ResourceExecutionState.prototype,
    'status',
    void 0
);
...
ResourceExecutionState = __decorate(
    [Scope(InstanceScope.TRANSIENT), __metadata('design:paramtypes', [])],
...
class Resource {
    ...
    [EXECUTE](
        ...
        const lastExecutionAbortController =
            (_a = this.state) === null || _a === void 0
                ? void 0
                : _a.abortController;
    ...
    resolveResponseBody(response) {
        return __asyncGenerator(
            ...
            function* resolveResponseBody_1() {
                ...
                const contentType =
                    (_a = headers.get('content-type')) === null || _a === void 0
                        ? void 0
                        : _a.join(', ');
    ...
    handleHttpErrorResponse(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contentType =
                (_d = headers.get('content-type')) === null || _d === void 0
                    ? void 0
                    : _d.join(', ');
            const datas = [];
            try {
                for (
                    var _e = true,
                        _f = __asyncValues(this.resolveResponseBody(response)),
                        _g;
            ...
            const responseBody = isTextEventStream(contentType)
                ? datas
                : datas[0];
...
__decorate(
    [Signal(), __metadata('design:type', ResourceExecutionState)],
    Resource.prototype,
    'state',
    void 0
);
__decorate(
    [Inject(), __metadata('design:type', ApplicationContext)],
    Resource.prototype,
    'ioc',
    void 0
);
...
__decorate(
    [Inject(), __metadata('design:type', SWRService)],
            ...
            function* resolveResponseBody_1() {
                ...
                if (isTextEventStream(contentType)) {
                    ...
                    yield __await(
                        yield* __asyncDelegator(
                            __asyncValues(
                                _super.resolveResponseBody.call(this, response)
                            )
                        )
                    );
                }
...
__decorate(
    [Signal(), __metadata('design:type', Progress)],
...
class CacheInterceptor {
    ...
    constructor(config = {}) {
        this.config = Object.assign(
            Object.assign({}, DEFAULT_CACHE_CONFIG),
            config
        );
    }
    getBucket() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (
                ...
                return HttpResponse.of(
                    Promise.resolve(
                        new BlobByteStream(new Blob([response.body]))
                    ),
                    headers,
                    response.status,
                    method
            ...
            if (status >= 200 && status < 300) {
                response.onBodyComplete(body =>
                    __awaiter(this, void 0, void 0, function* () {
                        var _a, _b, _c;
                        const headers = yield response.headers();
                        const bodyArrayBuffer = yield body.readAsBuffer();
                        // Determine expiration time
                        const headerExpiration =
                            this.getExpirationFromHeaders(headers);
                        const ttl = this.policy.getTTL(method, params);
                        const expiresAt =
                            headerExpiration !== null &&
                            headerExpiration !== void 0
                                ? headerExpiration
                                : ttl === 0
                                  ? 0
                                  : Date.now() + ttl;
...
__decorate(
    [Inject(DEFAULT_HTTP_CONFIGURATION), __metadata('design:type', Object)],
    CacheInterceptor.prototype,
    'httpConfig',
    void 0
);
