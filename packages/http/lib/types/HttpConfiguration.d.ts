...
export interface HttpConfigurationOptions {
    ...
    search?: URLSearchParams | Record<string, string | number | boolean | Array<string | number | boolean>>;
    headers?: Record<string, string | string[]>;
    fetcher?: Fetcher;
    validateStatus?(response: HttpResponse): Promise<boolean>;
    trigger?: HttpRequestTriggerOptions | Newable<HttpRequestTrigger> | HttpRequestTrigger;
