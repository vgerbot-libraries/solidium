...
export type RevalidateStrategyFunction = (revalidate: (reason?: string) => void) => void;
export interface RevalidateStrategy {
    invoke(revalidate: (reason?: string) => void): void;
}
export declare function isRevalidateStrategyClass(value: unknown): value is RevalidateStrategy;
export declare function isRevalidateStrategyFunction(value: unknown): value is RevalidateStrategyFunction;
