...
var solidiumPersistence = require('@vgerbot/persistence');
                ...
                return __generator(this, function (_j) {
                    switch (_j.label) {
                        ...
                        case 1:
                            ...
                            (_a = true),
                                (_b = __asyncValues(this.textStream(encoding)));
                            _j.label = 2;
                        case 2:
                            return [4 /*yield*/, __await(_b.next())];
                        case 3:
                            if (!((_c = _j.sent()), (_e = _c.done), !_e))
                                return [3 /*break*/, 7];
                            _g = _c.value;
                            _a = false;
                            chunk = _g;
...
var HttpHeaders = /** @class */ (function () {
    ...
    HttpHeaders.prototype.append = function (name) {
        ...
        var originValues =
            (_a = this.headers.get(name)) !== null && _a !== void 0 ? _a : [];
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1:
                            ...
                            (_a = true),
                                (_b = __asyncValues(readStream(stream)));
                            _g.label = 2;
                        case 2:
    ...
    var pathParamReplacedURL = routeTemplate.replace(
        ...
        function (fullMatch, placeholder, variableName) {
            ...
            if (variableName in pathVariables) {
                return (_b =
                    (_a = pathVariables[variableName]) === null || _a === void 0
                        ? void 0
...
var HttpStatusError = /** @class */ (function (_super) {
    ...
    function HttpStatusError(
        ...
        var _this =
            _super.call(
                this,
                message || 'HTTP Error '.concat(status, ': ').concat(statusText)
            ) || this;
        _this.status = status;
...
var GoneError = /** @class */ (function (_super) {
    ...
    function GoneError(headers, responseBody, message) {
        ...
        return (
            _super.call(this, 410, 'Gone', headers, responseBody, message) ||
            this
        );
    }
    return GoneError;
...
var LockedError = /** @class */ (function (_super) {
    ...
    function LockedError(headers, responseBody, message) {
        ...
        return (
            _super.call(this, 423, 'Locked', headers, responseBody, message) ||
            this
        );
    }
    return LockedError;
    ...
    function ServerError(status, statusText, headers, responseBody, message) {
        return (
            _super.call(
                ...
                responseBody,
                message ||
                    'Server Error: '.concat(status, ' ').concat(statusText)
            ) || this
        );
    }
    return ServerError;
...
var RequestMethod = /** @class */ (function () {
    ...
    RequestMethod.prototype.resolveURL = function (params) {
        ...
        return resolveURL(
            this.url,
            (_a = params.pathVariables) !== null && _a !== void 0 ? _a : {},
            params.queryParams
        );
    };
            ...
            (_c =
                (_b =
                    (_a = params.adapter) !== null && _a !== void 0
                        ? _a
                        : this.metadata.getAdapter()) !== null && _b !== void 0
                    ? _b
    ...
    Http.configure = function (config) {
        /** @class */ (function () {
            ...
            __decorate(
                [
                    ioc.Inject(),
                    __metadata('design:type', solidiumPersistence.Persistence)
                ],
            ...
            __decorate(
                [
                    ...
                    __metadata('design:type', solidiumPersistence.Bucket)
                ],
                HttpConfigurationFactory.prototype,
                'defaultBucket',
                void 0
...
function buildEndpointClass(endpointClass, metadata) {
    Reflect.set(endpointClass.prototype, GET_INTERCEPTORS, function (exclude) {
        ...
        var globalInterceptors =
            (_b =
                (_a = this[HTTP_CONFIGURATION]) === null || _a === void 0
                    ? void 0
...
var RequestMethodMetadata = /** @class */ (function () {
    ...
    RequestMethodMetadata.prototype.getInterceptors = function () {
        var _a;
        return (
            (_a = this.options.interceptors) !== null && _a !== void 0 ? _a : []
        ).concat(this.externalInterceptors);
    };
    RequestMethodMetadata.prototype.getExcludeInterceptors = function () {
        var _a;
        return (_a = this.options.excludeInterceptors) !== null && _a !== void 0
            ? _a
            : [];
    };
...
var EndpointMetadata = /** @class */ (function () {
    ...
    EndpointMetadata.prototype.setOptions = function (endpointOptions) {
        ...
        this.baseURL = joinPath(
            this.baseURL,
            (_b = endpointOptions.path) !== null && _b !== void 0 ? _b : ''
        );
...
function Request(options) {
    ...
    function delegator(originFunction, methodMetadata) {
        return function () {
            ...
            if (!method) {
                var error = new Error(
                    'Not found method '.concat(methodMetadata.name.toString())
                );
                throw error;
            }
            setExecutionContext({
    ...
    return function (target, methodName, parameterIndex) {
        appendExecHandler(
            ...
            function (instance, metadata, params, args) {
                ...
                var _b;
                var value =
                    (_b = args[parameterIndex]) !== null && _b !== void 0
                        ? _b
                        : defaultValue;
                if (value) {
    ...
    return function (target, methodName, parameterIndex) {
        appendExecHandler(
            ...
            function (instance, metadata, params, args) {
                var _a;
                var value =
                    (_a = args[parameterIndex]) !== null && _a !== void 0
                        ? _a
                        : defaultValue;
                if (Array.isArray(value)) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        now = Date.now();
                        dedupingInterval =
                            (_a = this.config.dedupingInterval) !== null &&
                            _a !== void 0
                                ? _a
                                : 2000;
    ...
    SWRInstance.prototype.setupRefreshInterval = function () {
        ...
        if (
            ...
            this.refreshInterval = setInterval(function () {
                ...
                if (
                    (document.hidden &&
                        !((_a = _this.config.refresh) === null || _a === void 0
                            ? void 0
                            : _a.whenHidden)) ||
                    (!navigator.onLine &&
                        !((_b = _this.config.refresh) === null || _b === void 0
                            ? void 0
                            : _b.whenOffline))
                ) {
                    return;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                swrInstance === null || swrInstance === void 0
                                    ? void 0
                                    : swrInstance.mutate();
...
var Resource = /** @class */ (function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            headers = _b.sent();
                            contentType =
                                (_a = headers.get('content-type')) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.join(', ');
                        ...
                        case 11:
                            ...
                            return [
                                ...
                                __values(
                                    __asyncDelegator(
                                        __asyncValues(response.textStream())
                                    )
                                )
                            ];
                        case 12:
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        headers = _h.sent();
                        contentType =
                            (_g = headers.get('content-type')) === null ||
                            _g === void 0
                                ? void 0
                                : _g.join(', ');
                        datas = [];
    ...
    __decorate(
        [solidium.Signal(), __metadata('design:type', ResourceExecutionState)],
        Resource.prototype,
        'state',
        void 0
    );
    __decorate(
        [ioc.Inject(), __metadata('design:type', ioc.ApplicationContext)],
        Resource.prototype,
        'ioc',
        void 0
    );
...
var RestfulResource = /** @class */ (function (_super) {
    ...
    RestfulResource.prototype[EXECUTE] = function (force) {
        ...
        var mutate =
            (_a = methodMetadata.getExtra(EXTRA_METADATA_MUTATE)) !== null &&
            _a !== void 0
                ? _a
                : false;
                    ...
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                __values(
                                    __asyncDelegator(
                                        __asyncValues(response.jsonStream())
                                    )
                                )
                            ];
                        case 2:
    ...
    DownloadResource.prototype.handleResponse = function (response, state) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [
                    2 /*return*/,
                    _super.prototype.handleResponse.call(this, response, state)
                ];
            });
        });
    };
    ...
    CacheInterceptor.prototype.getBucket = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                bucketName =
                    (_a = this.config.bucketName) !== null && _a !== void 0
                        ? _a
                        : (_b = this.httpConfig) === null || _b === void 0
                          ? void 0
                          : _b.cacheBucket;
                if (bucketName) {
                    try {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (
                            cachedEntry &&
                            this.policy.isValid(cachedEntry, method, params)
                        ) {
