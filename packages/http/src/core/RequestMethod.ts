import type { AdapterOptions } from "../adapter/AdapterOptions";
...
export class RequestMethod {
	...
	async invoke(instance: EndpointInstance, params: ExecuteRequestMethodParams) {
	...
	resolveURL(params: ExecuteRequestMethodParams) {
		return resolveURL(this.url, params.pathVariables ?? {}, params.queryParams);
	}
